...
const startButton = document.getElementById('start-button'); // Make sure your button has id="start-button"

if (startButton) {
  startButton.addEventListener('click', () => {
    // Hide the start screen if needed
    const startScreen = document.getElementById('start-screen'); // Make sure your start screen has id="start-screen"
    if (startScreen) {
